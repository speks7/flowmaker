...
export class FlowOnBrowser {
  ...
  private SVGDownload(req, res) {
    ...
    if (!editor || editor.document.languageId !== "javascript") svg = " ";
    else {
    ...
    res.setHeader(
      "Content-disposition",
      "attachment; filename=" + fileName.replace(".js", ".svg")
    );
